    ...
    if uploaded_files:
        ...
        with st.spinner("Sedang memproses..."):
            for uploaded_file in uploaded_files:
                ...
                final_cols = [
                    "Tanggal", "Tahun", "Bulan", "Overview", "Deskripsi","No Akun", "Nama Akun", 
                    "Cost Type", "No Akun Analitik", "Nama Akun Analitik", "Kode Induk Analitik", 
                    "Kode Detail Analitik", "Tipe Unit", "Nominal"
                ]
