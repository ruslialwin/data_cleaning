...
if source == "Upload File Excel":
    ...
    API_URL = "https://dashboard.mahkotagroup.com/api/dashboard/realisasi"
    ...
    if st.button("Ambil Data Laba Rugi"):
        with st.spinner("Mengambil data dari API...."):
            ...
            filename=f"{company_map.get(company_id, company_id)}_{periode}_cleaned.xlsx"
    ...
    API_URL = "https://dashboard.mahkotagroup.com/api/dashboard/realisasi-terekam"
